...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql= $mysqli->query("INSERT INTO `categories` VALUES (NULL,'$category_name',CURRENT_TIMESTAMP)") or die(mysqli_error($mysqli));
}
    ...
    <div class="container-fluid">
      ...
      <div class="col-12">
        <div class="card-box">
          ...
          <form  method="POST" id="insert_category" class="insert_category" >
              <div class="alert"></div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                ...
                <input class="form-control" id="category_name" aria-required="true" type="text" name="category">

                </div>
                  </div>
                <div class=" form-group row">
                  <div class="col-sm-6 push-md-3">
                    <input type="submit" id="add_category"  class="btn btn-primary btn-large" name="submit" value="Save">
                  </div>
                </div>
  ...
  if($('#category_name').val() == ''){
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        $('#confirm').append('<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button>Category added successfully.</div>');
