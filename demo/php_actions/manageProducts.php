...
<body class="o-page">
  ...
  <main class="o-page__content">
    ...
    require "../connection/config.php";
      $fetch = $mysqli->query("SELECT categories.category_name,suppliers.supplier_name,products.product_id,products.product_name,products.product_quantity,products.sell_price,products.supplier_price FROM products JOIN categories ON categories.category_id=products.category_id JOIN suppliers ON suppliers.supplier_id=products.supplier_id");
    ...
    <div class="container-fluid">
      ...
      <div class="col-12">
        <div class="card-box">
          <h4 class="m-t-0 header-title">Manage Product</h4>
          <div class="row mt-4">
