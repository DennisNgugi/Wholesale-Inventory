...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  $supplier_name = $mysqli->escape_string($_POST['supplier_name']);
  $supplier_mobile = $mysqli->escape_string($_POST['supplier_mobile']);
  $supplier_address = $mysqli->escape_string($_POST['supplier_address']);
  $supplier_details = $mysqli->escape_string($_POST['supplier_details']);

  $sql = $mysqli->query("INSERT INTO `suppliers` VALUES (NULL,'$supplier_name','$supplier_mobile','$supplier_address','$supplier_details',CURRENT_TIMESTAMP)");
}
else{
...
<body class="o-page">
  ...
  <main class="o-page__content">
    <header class="c-navbar u-mb-medium">
      ...
      <h2 class="c-navbar__title u-mr-auto">Suppliers</h2>
    ...
    <div class="container-fluid">
      ...
      <div class="col-12">
        <div class="card-box">
          <h4 class="m-t-0 header-title">Add Supplier</h4>
  ...
  <script>
    $(document).ready(function() {
      $('#insert_supplier').on('submit',function(event){
          event.preventDefault();
          if ($('#supplier_name').val() == "") {
              alert('Supplier name field is required');
          }
        else if ($('#supplier_mobile').val() == "") {
              alert('Supplier_mobile field is required');
          }
          else{
          $.ajax({
            method:"POST",
            ...
            success:function(data){
              ...
              $('#confirm').append('<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button>sSupplier added successfully.</div>');
